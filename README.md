...
| 항목 | 결과 |
|---|---|
| **착과수 예측 v3** (개체 추적 + 개체 lag) | 집계 **R² 0.94** · **개체 R² 0.84** |
...
│  ├─ train_individual.py    # v3 — 개체 추적(온실+라인+표본) + 개체 lag (집계 0.94·개체 0.84)
...
| 문서 | 내용 |
|---|---|
| [착과수 개체별 결과지 (v3)](docs/report/착과수_개체별_결과지.html) | 개체 40개 × 15주 궤적(실제 vs 예측) · 개체 R² 0.84 |
